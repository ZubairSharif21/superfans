...
<a href="https://superfans.world/">
    <img src="{{ url('assets/images/' . $logo) }}" style="width: 54%;margin-bottom: 14px;">
                        ...
                        <p style="color:black;text-align: center;">{{ __('auth.Login_des') }}</p>
...
@endif
                        ...
                        <button type="submit" id="sendlogin" class="btn " style="padding-right: 11px !important; padding-left: 11px !important; background-color: limegreen;border-color: limegreen; color: #fff; font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif !important;text-decoration:none;border: 3px solid green;margin-left: auto;display: block;font-size: 1.1em !important; margin-top: 10px;font-weight:900 !important;border-radius:0px !important;"><b>{{ __('auth.Login_btn') }}<font style="width:11px; height:11px;background:#00e172;border-radius:45px;color:#00e172;font-size:0.83em; margin-left: 4px;">..</font></b></button>
                    </form>
