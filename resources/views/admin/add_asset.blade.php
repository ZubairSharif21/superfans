        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 offset-sm-3 ">
                <div class="card">
                    <div class="card-body ">
                        <div>
                            <h3 style="text-align: center;">Add Asset</h3>
                        </div>
                        <form method="post" action="/admin/add_new_asset" enctype="multipart/form-data" id="add_asset_form">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="icon" class="custom-file-input" id="exampleInputFile" required>
