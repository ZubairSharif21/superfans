...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Superfans | 419 Not Found</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Nueva Modelo Superfans - ¡Bienvenid@ a mi Portfolio!" />
	<meta name="keywords" content="influencer, model, instagram, web model, fans, social, portfolio, photography" />
	<meta name="author" content="MH11 & Co-Management" />
...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=BBH+Sans+Bogle&display=swap" rel="stylesheet">
	...
	_smartsupp.key = 'b4fb4c515b68634c97710197d3ab3cd08c320e7b';
...
<img src="{{ url('assets/images/' . $logo) }}" alt="Supermon Logo" class="logo" />
			...
			<br><br>
			<h2 style="margin-left: 11px; margin-right: 11px;">¡Ups! La página Caducó</h2>
			<h3 style="margin-left: 11px; margin-right: 11px;">Superworld es una red social protegida, por seguridad las páginas caducan muy rápido. <br><br> Inicia sesión de nuevo porfavor!</h3>

			<br>
			{{-- href="javascript: refresh" --}}
		<button  id="back_btn" class="btn btn-primary btn-outline">Iniciar sesión</button>
