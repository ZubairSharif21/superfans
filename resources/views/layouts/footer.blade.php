...
<div class="modal-body" style="border: 0px">
    ...
    @if (Auth::check())
        ...
        <div class="modal" id="followerlistmodal" tabindex="-1" role="dialog"
          ...
          font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif;">
                                        <img @if ($profile_picture != null)
                                             ...
                                             @endif style="max-width: 32px;border-radius: 35px;"
                                             alt=""> {{$user->username_URL}}</p>
        ...
        <!-- Modal Likes list -->
        <div class="modal" id="LikesModalCenter" tabindex="-1" role="dialog"
             aria-labelledby="subcriberlistModalCenterTitle" aria-hidden="true" style="z-index: 1288912889;">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="border-radius: 20px;background: red;">
                    <div class="modal-header" style="border: 0px">
                                ...
                                @foreach ($posts as $post)
                                    ...
                                    <div class="post_div post_div_{{$post->id}}">
                                        ...
                                        @if ($post_likes_count > 0)
                                            ...
                                            @endforeach
                                        @else
                                            <p style="margin: 0px;text-align: center;color: white;">Post don't have
                                                likes yet</p>
                                        @endif
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="border-radius: 20px;background: red;">
                    ...
                    <div class="modal-body post-modal" style="border: 0px">
                        ...
                        <form action="{{ url('/user/add_post') }}" id="add_post_form" method="post"
...
<br />
                             <center><button type="submit" class="save_btn  turn_btn"
                                    style="background: #724abb; margin-top: 5px; color: #fff;padding: 4px 35px;font-weight: 900;border: 0px;outline: 0px; font-size:1.1em; border: 3px solid #4712a6; font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif !important;">
...
@endphp
             ...
             $file_extension = pathinfo($image_video, PATHINFO_EXTENSION);
              ...
              @endphp
               ...
               @if (in_array(strtolower($file_extension), $video_extensions))
                    ...
                    <form action="{{ URL('/user/visible_post/' . $id) }}" method="POST" style="display: inline;">
                        @csrf
                    ...
                    <!-- Delete Post -->
                                            ...
                                            <span href="{{ URL('/user/delete_post/'.$id.'')}}" class="delete"
                                                  type="post"><i class="fa fa-trash"
                                    ...
                                    <center>
                                        <div
                                        style="display: inline-block;vertical-align: super;background: white;color: black;padding-left: 10%;padding-right: 10%;cursor: pointer;color: red;padding-top: 5px;padding-bottom: 5px;"
  ...
  <!-- Seen Button -->
    <br /><br />
   <p style="color: white; font-weight: 600; margin: 0px; margin-top: 20px;">Turn all ON / Turn all OFF</p>
   <br /> 
<div class="col-md-3" style="text-align: end; padding-right: 22px;">
    <form method="POST" action="{{ url('/user/toggle_all_visibility') }}" style="display: inline;">
        @csrf
             ...
             $file_extension = pathinfo($image_video, PATHINFO_EXTENSION);
              ...
              @endphp
               ...
               @if (in_array(strtolower($file_extension), $video_extensions))
                                            ...
                                            @endif
                                            {{-- onclick ="return confirm('Are you sure?')" --}}
                                            <span href="{{ URL('/user/delete_all_post/'.$id.'')}}" class="delete"
                                                  type="post"><i class="fa fa-trash"
                                                                 style="position: absolute;margin-left: -8px;color: white;"></i></span>
                                        </div>
                                    @endforeach
...
@endphp
                           ...
                           <form id="colorForm" action="{{ route('user.updateCoverColor') }}" method="post">
    @csrf
    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
    ...
    style="margin-bottom: 15px; padding: 8px; width: 100%; box-sizing: border-box; color: white; background-color: #333; border: 1px solid #ccc; border-radius: 4px;"
    required>
    <option value="" disabled {{ $user->cover_picture ? 'selected' : (!$user->cover_color ? 'selected' : '') }}>
        Select color
    </option>
    <option value="yellow" {{ $user->cover_color === 'yellow' && !$user->cover_picture ? 'selected' : '' }}>
        Yellow
    </option>
    <option value="purple" {{ $user->cover_color === 'purple' && !$user->cover_picture ? 'selected' : '' }}>
        Purple
    </option>
</select>
...
<script>
 ...
 <form action="{{ url('/user/update_gender') }}" method="post" enctype="multipart/form-data" style="margin-top: 20px;">
    @csrf
    <input type="hidden" name="influencer_id" value="{{ Auth::user()->id }}">
        ...
        <div class="row pb-3">
            <div class="col-md-9">
                <div class="form-group" style="display: flex; align-items: center;">
                    <label for="gender" style="color: white; margin-right: 10px;">{{ __('content.gender') }}</label>
                    <select name="gender" id="gender" class="form-control" style="background: white; height: 40px; width: 100%; padding: 0 20px;">
                        <option value="" disabled>Select Gender</option>
                        <option value="Man" {{ Auth::user()->gender == 'Man' ? 'selected' : '' }}>Man</option>
                        <option value="Woman" {{ Auth::user()->gender == 'Woman' ? 'selected' : '' }}>Woman</option>
                        <option value="Trans" {{ Auth::user()->gender == 'Trans' ? 'selected' : '' }}>Trans</option>
                        <option value="Binary" {{ Auth::user()->gender == 'Binary' ? 'selected' : '' }}>Binary</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3" style="text-align: end; padding-right: 22px;">
                <button type="submit" class="save_btn"
                    ...
                    {{ __('content.save_button_cpanel') }}
                        ...
                        <form action="{{ url('/user/update_birth') }}" method="post" enctype="multipart/form-data" style="margin-top: 20px;">
    @csrf
    <input type="hidden" name="influencer_id" value="{{ Auth::user()->id }}">
    ...
    <div class="container-fluid" style="padding-left: 0px;">
        <div class="row pb-3">
            <div class="col-md-9">
                <div class="form-group" style="display: flex">
                    <label for="birth" style="color: white">{{ __('content.birth') }}</label>
                    <input type="text" class="form-control" id="birth"
                           style="background: white;height: 40px;" name="birth"
                           value="{{ Auth::user()->birth }}" placeholder="e.g. 7, Oct 1996" required>
                </div>
            </div>
...
<form action="{{ url('/user/update_country') }}" method="post" enctype="multipart/form-data" style="margin-top: 20px;">
    @csrf
    <input type="hidden" name="influencer_id" value="{{ Auth::user()->id }}">
    ...
    <div class="container-fluid" style="padding-left: 0px;">
        <div class="row pb-3">
            <div class="col-md-9">
                <div class="form-group" style="display: flex">
                    <label for="country" style="color: white">{{ __('content.country') }}</label>
                    <input type="text" class="form-control" id="country"
                           style="background: white;height: 40px;" name="country"
                           value="{{ Auth::user()->country }}" placeholder="e.g. Spain" required>
                </div>
            </div>
...
@endif
            ...
            <!-- Modal add post settings -->
            {{-- <div class="modal @if(session()->has('post_added')) fade in @else fade @endif " id="add_post_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="z-index: 123122;@if(session()->has('post_added')) display: block; @endif">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="border-radius: 20px;background: red;">
                  <div class="modal-header" style="border: 0px">
                    ...
                    <h5 class="modal-title" id="exampleModalCenterTitle" style="font-size: 30px;text-align: center;color: white;display: inline-block;">{{ __('nav.add_post') }}</h5>
                  </div>
                  </div>
                  <div class="modal-body" style="border: 0px">
                    ...
                    @php
                        $posts = DB::table('posts')->where('influencer_id',Auth::user()->id)->orderBy('id', 'desc')->limit(5)->get();
                    @endphp
                    ...
                    <div class="container-fluid">
                      <div class="row">
                        <div class="col-md-9">
                          ...
                          <div style="padding-left: 1%;padding-right: 1%;display: inline-block;">
                            <img src="{{ asset('assets/images/'.$image_video.'') }}" style="max-width: 70px;display: inline-block;" alt="Nueva Modelo - ¡Bienvenid@ a mi Portfolio!" class="img-responsive">
                            <a href="{{ URL('/user/delete_post/'.$id.'')}}" onclick ="return confirm('Are you sure?')"><i class="fa fa-trash" style="position: absolute;margin-left: -8px;color: white;"></i></a>
                          </div>
                          @endforeach
                        </div>
                        <div class="col-md-3" style="text-align: end;padding-right: 22px;">
            ...
            <div class="modal @if(session()->has('post_limit_reached')) fade in @else fade @endif "
                 id="post_limit_reachedModalCenter" tabindex="-1" role="dialog"
                 aria-labelledby="post_limit_reachedModalCenterTitle" aria-hidden="true"
                 style="z-index: 123122;@if(session()->has('post_limit_reached')) display: block; @endif">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content" style="border-radius: 20px;background: red;">
                        <div class="modal-header" style="border: 0px">
                            <button type="button" class="close d-block " data-dismiss="modal" aria-label="Close"
                        ...
                        <div class="modal-body" style="border: 0px">
                            ...
                            <p style="color: white;font-weight: 600;margin: 0px;margin-top: 20px;">Solo puedes subir
                                hasta 3 posts
                                con este tipo de cuenta / You only can upload 3 posts with this account
                            </p>
            ...
            <!-- Another Modal influencer settings for User pages -->
            @if (Auth::check())

                @if (Auth::user()->role == "influencer")

                    <div class="modal @if(session()->has('message')) fade in @else fade @endif " id="exampleModalCenter"
                         tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"
                                ...
                                <div class="modal-body" style="border: 0px">
                                    ...
                                    <form action="{{ url('/influencer/update_profile_image') }}" method="post"
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <label for="" style="margin-right: 10px;color: white;margin-top: 3px;"
                                                   class="col-sm-3 col-form-label">Profile
                                                Picture</label>

                                            <div class="col-sm-6">
                                                <input type="file"
                                                       class="form-control-file custom-file-input profile_picture"
                                                       name="profile_image" id="profile_picture2"
                                                       style="color: white;margin-top: 3px;" required>
                                    ...
                                    <form action="{{ url('/influencer/update_cover_image') }}" method="post"
                                        ...
                                        <div class="custom-file" style="display: flex;">
                                            ...
                                            <label for="" style="margin-right: 10px;color: white;margin-top: 3px;">Cover
                                                Picture</label>

                                            <input type="file" class="custom-file-input cover_picture"
                                                   name="cover_image" id="validatedCustomFile"
                                                   style="color: white;margin-top: 3px;" accept="image/*" required>
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <label for="email" style="color: white">My username / url
                                                            link: </label>

                                                        <input type="text" class="form-control" id="email"
                                                               style="background: white;height: 40px;"
                                                               name="username_url" value="{{$user->username_URL}}"
                                                               required>
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <label for="email" style="color: white;white-space: nowrap;">Price
                                                            of fee: </label>

                                                        <input type="text" class="form-control"
                                                               id="price_of_subscription"
                                                               style="background: white;height: 40px;"
                                    ...
                                    {{-- <form action="{{ url('/influencer/footer_name_username') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div>
                                            ...
                                            @foreach($Influencer_network_ids as $Influencer_network_id)
                                                ...
                                                <button class="networkmodal" network_name="{{$socialnetwork_name}}"
                                                        ...
                                                        href="{{$Influencer_networks_profile_links[$index]}}"
                                                        style="background: white;color: red;padding: 3px 15px;font-weight: bold;border: 0px;outline: 0px;position: relative;height: fit-content;margin-right: 21px;margin-top: 10px;margin-bottom: 10px;">{{$socialnetwork_name}}</button>
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <input type="text" class="form-control" id="email"
                                                               style="background: white;height: 40px;"
                                                               name="network_url" value="" required>
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-xs-6" style="text-align: end;padding-right: 22px;">
                                                    ...
                                                    <button type="button" class="save_btn"
                                                            style="background: white;color: red;padding: 3px 15px;font-weight: bold;border: 0px;outline: 0px;"
                                                            data-toggle="modal" data-target="#withdraw_earnings_modal">
                                                        Withdraw money
                                                    </button>
                                        ...
                                        <div class="row pb-3">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <div class="form-group" style="display: flex">
                                                    ...
                                                    <label for="email" style="color: white">History of
                                                        Subscribers:</label>
                                            ...
                                            <div class="col-xs-6" style="text-align: end;padding-right: 22px;">
                                                ...
                                                <button type="button"
                                                        class="launch_subscriber_list_modal launch_sub_modal save_btn"
                                                        style="background: white;color: red;padding: 3px 15px;font-weight: bold;border: 0px;outline: 0px;"
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <input type="text" class="form-control" id="email"
                                                               style="background: white;height: 40px;"
                                                               name="bank_account" value="{{$user->bank_account}}"
                                                               required>
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <input type="text" class="form-control" id="email"
                                                               style="background: white;height: 40px;"
                                                               name="paypal_account" value="{{$user->paypal_account}}"
                                                               required>
                                    ...
                                    <form action="{{ url('/influencer/update_email') }}" method="post"
                                          enctype="multipart/form-data" style="margin-top: 20px;">
                                    ...
                                    <form action="{{ url('/influencer/update_password') }}" method="post"
                                          enctype="multipart/form-data" style="margin-top: 20px;">
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group" style="display: flex">
                                                        ...
                                                        <input type="text" class="form-control" id="email"
                                                               style="background: white;height: 40px;" name="password"
                                                               value="" required>
                                    ...
                                    <form action="{{ url('/influencer/update_name') }}" method="post"
                                          enctype="multipart/form-data" style="margin-top: 20px;">
                                    ...
                                    <form action="{{ url('/influencer/update_surname') }}" method="post"
                                          enctype="multipart/form-data" style="margin-top: 20px;">
            ...
            font-weight: bold;
            font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif;
        "><span>@</span>{{$influencer->username_URL}}</p>

                                                    <div
                                                        style="text-align: right;margin-bottom: -25px;margin-right: -13px;">

                                                        <span href="/user/delete_subscription/{{$subscription->id}}"
              ...
              "><img @if ($profile_picture != null)
                     ...
                     @endif style="max-width: 28px" alt=""> <span>@</span>{{$userFollowed->username_URL}}</p>
                                                ...
                                                @endforeach
                                            @else
                                                <p style="margin: 0px;text-align: center;color: white;">No
                                                    Followerships</p>
                                            @endif
                                            ...
                                            <center><a href="mailto:marketing@superfanss.app" class="btn"
                                                       style="background: transparent;color: white;border: 2px solid white;">{{ __('content.contratar') }}</a>
                                            </center>
    ...
    document.addEventListener('click', function (e) {
        if (!e.target.closest('#tag-suggestions') && !e.target.closest('#tagged_users')) {
            tagSuggestionBox.style.display = 'none';
                                ...
                                $(document).ready(function () {
                                    ...
                                    $("#influencer_select").change(function () {
                                        ...
                                        if ($("#influencer_select").val() == "All influencers") {
                                            ...
                                            window.location.href = "/user/influencers";
                                            ...
                                            $("#influencer_select").val("Buscar Influencer");
                                            window.location.href = "/user/influencer/" + current_value + "";
                                        }
                                    ...
                                    $("#user_select").change(function () {
                                        ...
                                        if ($("#user_select").val() == "All users") {
                                            ...
                                            $("#user_select").val("Buscar User");
                                            window.location.href = "/user/user/" + current_value + "";
                                        }
                            ...
                            @if(session()->has('post_limit_reached'))
                                <script type="text/javascript">
                                    $(window).on('load', function () {
                                        $('#post_limit_reachedModalCenter').modal('show');
                                    });
                                </script>
                            @endif
            ...
            @endif
                            ...
                            <script>
                                $(document).ready(function () {
                                    ...
                                    $(".control_panel_item").click(function (e) {
                            ...
                            <script
                                src="https://cdn.jsdelivr.net/npm/sweetalert2@11.3.6/dist/sweetalert2.all.min.js"></script>
