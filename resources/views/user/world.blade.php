    ...
    <script>
     ...
     let clickCount = 0;
        ...
        <hr style="margin-bottom: 20px;">    
              ...
              <li class="fh5co-active world_after"><a href="{{ URL('/user/world')}}">{{ __('nav.world') }}</a></li>
...
<div class="modal fade" id="tourModal" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <h3 class="modal-title" style="color:#fff; font-family: Consolas, Menlo, Monaco, 'Lucida Console', monospace; font-weight:900;    text-align: center;
    margin-top: 15px;">
      ...
      <!--  <h3 class="modal-title" style="color:#fff; font-family: Consolas, Menlo, Monaco, 'Lucida Console', monospace; font-weight:900;">-->
      <!--    ✈️ {{ __('content.tourModalTitle') }}-->
      <!--  </h3>-->
