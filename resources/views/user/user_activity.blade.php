...
<div id="fh5co-page">
    ...
    border-radius: 30px;vertical-align: middle;"></span><span>@</span>{{$user->username_URL}}</p>
      ...
      @endphp
          ...
          <li> <a class="fh5co-active" href="{{ URL('/user/user/'.$username_URL.'')}}" style="text-decoration: underline;text-transform: uppercase;
          ...
          <li> <a href="{{ URL('/user/user_posts/'.$username_URL.'')}}" style="text-transform: uppercase;
...
{{--                <li><a href="{{Auth::user()->instagram_link}}"><i class="icon-instagram" style="font-size: 2.1em;"></i></a></li>--}}
    ...
    <div id="fh5co-main">
        ...
        @endif --}}
            ...
            <b><a href="{{ URL('/user/user_posts/'.$username_URL.'')}}" style="font-size: 0.69em;">{{$posts_count}}</b> {{ __('content.post') }}</a> | <b><a href="#" @if ($followership != null) data-toggle="modal" data-target="#LikesModalCenter" @endif style="font-size: 0.69em;"><span class="number_of_likes">{{thousandsCurrencyFormat($likes_count)}}</span></b> {{ __('content.likes') }} </a> | <b><a href="#" @if ($followership != null) data-toggle="modal" data-target="#followerlistmodalanotheruser" @endif class="direct_subscriber_list" style="font-size: 0.69em;">{{thousandsCurrencyFormat($subscription_count)}}</b> {{ __('content.followers') }}</a>

            

                              <!-- Modal Likes list -->

                              <div class="modal" id="LikesModalCenter" tabindex="-1" role="dialog" aria-labelledby="subcriberlistModalCenterTitle" aria-hidden="true" style="z-index: 1288912889;">
            ...
            {{-- class="col-xs-3 " --}}
            <div  style="padding-left: 5px;padding-right: 5px;max-width: 225px;display: inline-block;">
                         ...
                         {{ format_number($post_likes_count+$likes_no);}}
                          ...
                          <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item" style="display: flex;align-items: center;">
                            ...
                            <center style="width: 100%;margin-bottom: 0.29em;">
                              ...
                              <a href="{{ URL('/user/user_posts/'.$username_URL.'')}}" class="btn btn-primary btn-outline">{{ __('content.all_posts') }}</a>
