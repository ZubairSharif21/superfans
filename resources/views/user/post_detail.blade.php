    ...
    @endif </p> --}}
          ...
          <ul style="list-style-type: none;font-size: 14px;width: 100%;padding: 0px 26%;">
            <li style="text-align: center;"> <a href="#" style="pointer-events: none;text-transform: uppercase;
              color: #222;
              font-size: 0.83em;
              font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif !important;">{{ __('nav.wall') }}s</a> </li>
          </ul>
          @endif
...
<div class="spotlight-group" data-fit="contain" data-autohide="all">
  ...
  @endphp        
    ...
    @endforeach
                    ...
                    {{-- <img src="{{ asset('assets/images/'.$image_video.'') }}" alt="Nueva Modelo Superfans - ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Bienvenid@ a mi Portfolio!" class="img-responsive" style="border-radius: 26px !important;  border: 7px solid lightgray;"> --}}
          ...
          <center>
              <span class="btn btn-primary btn-outline like_post"target="_blank"style="width: 292px !important;"  post_id="{{$current_post->id}}">
                  ...
                  <center><img src="{{ asset('assets/images/blue24.png') }}" alt="Nueva Modelo Superfans - ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Bienvenid@ a mi Portfolio!" class="img-responsive" style="border-radius: 26px !important;  border: 7px solid lightgray;">
            ...
            @if ($influencer->role == "influencer")
                ...
                <center>
                  <span data-toggle="modal" data-target="#paymentModalCenter" class="btn btn-m btn-primary btn-outline btn-outline-default" ><img src="{{ asset('assets/images/SUPERHEROINA.svg') }}" style="width: 38px; position: relative; left: -4px;">{{ __('content.subscribe') }} <b>+</b> {{ __('content.to_see_post') }} | <b>${{$influencer->price_of_subscription}}</b></span><br>
                </center>
                    ...
                    <div class="modal-content" style="border-radius: 20px;background: red;">
                      ...
                      <div class="modal-body" style="border: 0px">
                        ...
                        <p style="font-size:0.74em;">
                                ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚ÂªÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â¸ Usted se suscribirÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ a la tarifa mensual base de un Influencer con TRES meses de permanencia si se suscribe a una tarifa de oferta de bienvenida inferior a unÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³larÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â oÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â unÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â euro <br>
                                ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚ÂºÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â¸ You will be subscribed to the base monthly rate of an Influencer with a three-month commitment if you subscribe to a welcome offer rate of less than one dollarÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â orÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â oneÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â euro.</p>
            ...
            @else
              ...
              <form action="{{ url('/user/follow') }}" method="post" enctype="multipart/form-data">
                @csrf                  
                  ...
                  <center>
                    <button @if(Auth::user()->id == $user->id) data-toggle="modal" data-target="#userModalCenter" type="button" @endif class="btn btn-primary btn-outline" style="width: 226px !important;"><img src="{{ asset('assets/images/SUPERHEROINA.svg') }}" style="width: 38px; margin: 3px; position: relative; left: -4px;">{{ __('content.follow') }}  <b>+</b></button><br>
                  </center>
              </form>
