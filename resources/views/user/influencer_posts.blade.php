...
<div id="fh5co-page">
    ...
    border-radius: 30px;vertical-align: middle;"></span><span>@</span>{{$user->username_URL}}</p>
      ...
      @endphp
          ...
          <li> <a  href="{{ URL('/user/influencer/'.$username_URL.'')}}" style="text-transform: uppercase;
          ...
          <li> <a class="fh5co-active" href="{{ URL('/user/influencer_posts/'.$username_URL.'')}}" style="text-decoration: underline;text-transform: uppercase;
...
$likes = DB::select("SELECT * FROM posts WHERE id = ". $post->id);
                              ...
                              <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a class="post_stats" style="font-size: 0.69em;" @if ($subscription === null) data-toggle="modal" data-target="#paymentModalCenter" @endif ><span class="number_of_post_likes post_likes_{{$post->id}}">sds
                          ...
                          <div class="col-md-7 col-md-push-1">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                ...
                                <p style="font-weight: 300;">{!! __('footer.lead_paragraph_3') !!}En Superfans, ya mÃ¡s de 11.000 influyentes con sÃ³lo 38K de seguidores estÃ¡n generando mÃ¡s de $650 mensuales. AdemÃ¡s, a parte de rentabilizar tu Instagram, haremos <u>subir tus Seguidores</u>.</p>
