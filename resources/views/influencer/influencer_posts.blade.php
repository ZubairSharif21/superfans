...
<div id="fh5co-page">
    ...
    border-radius: 30px;vertical-align: middle;"></span><span>@</span>{{$user->username_URL}}</p>
      ...
      @endphp
          ...
          <li> <a  href="{{ URL('/influencer/influencer/'.$username_URL.'')}}" style="text-transform: uppercase;
          ...
          <li> <a class="fh5co-active" href="{{ URL('/influencer/influencer_posts/'.$username_URL.'')}}" style="text-decoration: underline;text-transform: uppercase;
               ...
               @if (in_array(strtolower($file_extension), $video_extensions))
                        ...
                        <center>
                          ...
                          @if (count($all_posts) > 0)
                            ...
                            {{-- <a href="{{ URL('/influencer/posts')}}" class="btn btn-primary btn-outline">All Post</a> --}}
