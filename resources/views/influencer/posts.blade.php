    ...
    <div id="fh5co-page">
        ...
        <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
          ...
          padding-left: 6px;padding-right: 6px;font-size: 14px;width: 50%;position: relative;overflow-x: hidden;overflow-y: hidden;">
            ...
            font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif !important;">MY
                        POSTS</a> </li>
        ...
        document.querySelectorAll('.play-sound8').forEach(button => {
            button.addEventListener('click', () => {
                document.getElementById('clickSound8').play();
                        ...
                        <li class="fh5co-active"><a href="{{ URL('/influencer/posts') }}">{{ __('nav.posts') }}</a></li><br>
 ...
 {{-- Image or Video --}}
    ...
    @endif>
                    ...
                    @else
                        ...
                        <p style="text-align: center;"><img src="{{ url('assets/images/time_icon.PNG') }}"
                                style="margin-top: -7px;height: 32px;width: 25px;" alt=""> No hay posts todabÃ­a
                            &nbsp;&nbsp; <span data-toggle="modal" data-target="#add_post_modal"
