...
@section('content')
    ...
    @php
        ...
        $other_influencer_user_id = $id;
    @endphp


    <div class="modal" id="PostLikesModalCenterindividual_another_influencer_user2" tabindex="-1" role="dialog"
         aria-labelledby="subcriberlistModalCenterTitle" aria-hidden="true" style="z-index: 1898989898989898989898989;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 20px;background: red;">
                <div class="modal-header" style="border: 0px">
                    ...
                    {{-- <button type="button" class="close d-block "  style="font-size: 45px;opacity: 1;color: white;float: left;">
                                ...
                                @if ($post_likes_count > 0)
                                    @foreach ($post_likes as $post_like)
                                        ...
                                        <div
                                            ...
                                            <p style="margin: 0px">              @if ($profile_picture != null)
    ...
    border-radius: 30px;vertical-align: middle;"></span><span>@</span>{{$user->username_URL}}</p>
            ...
            <ul style="list-style-type: none;display: flex;font-size: 14px;width: 100%;justify-content: space-between;padding: 0px 26%;max-width: 300px;text-align: center;margin-left: auto;margin-right: auto;">
                ...
                <li><a href="{{ URL('/influencer/user/'.$username_URL.'')}}" style="text-transform: uppercase;
            ...
            font-family: Consolas, Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono, Bitstream Vera Sans Mono, Courier New, monospace, serif !important;">{{ __('nav.wall') }}</a>
                ...
                <li><a class="fh5co-active" href="{{ URL('/influencer/user_posts/'.$username_URL.'')}}" style="text-decoration: underline;text-transform: uppercase;
...
<audio id="clickSound8" src="{{ asset('assets/music/iPhoneLock-SoundEffect.mp3') }}"></audio>
        ...
        document.querySelectorAll('.play-sound8').forEach(button => {
            button.addEventListener('click', () => {
                document.getElementById('clickSound8').play();
                                            ...
                                            <div class="item @if($first_network == 1) active @endif ">
                                                ...
                                                <div class="item-content">
                                                    ...
                                                    <a href="{{$Influencer_networks_profile_links[$index]}}"><img
                                                            ...
                                                            width="69px" @if ($socialnetwork->id == 3  )
                        ...
                        <li><a href="{{ URL('/influencer/posts')}}">{{ __('nav.posts') }}</a></li>
                        <br>
                        ...
                        <li class="username_li" style="font-size: 80%;">
                            ...
                            <div class="dropdown">
                                ...
                                <p id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false" style="cursor: pointer;white-space: nowrap;transition: 0.3s;">
                                    <b>@</b><b>{{Auth::user()->username_URL}} <i class="far fa-user-circle"
                                                                                 style="font-size: 20px;"></i></b></p>
    ...
    border-radius: 30px;"
            ...
            <div class="fh5co-narrow-content" style="padding-top: 0px;margin-top: -54px;">
                ...
                @if(session()->has('duplicate_error'))
                    ...
                    <div class="alert alert-success"
                         style="position: absolute;min-width: fit-content;width: 200px;right: 35%;top: 9%;">
                    ...
                    @if ($followership === null)
                        ...
                        <form action="{{ url('/user/follow') }}" method="post" enctype="multipart/form-data">
                            ...
                            <button @if(Auth::user()->id == $user->id) data-toggle="modal"
                                    ...
                                    @endif class="btn btn-primary btn-outline" style="width: 226px !important;"><img
                                    src="{{ asset('assets/images/SUPERHEROINA.svg') }}"
                                    style="width: 17.47%; margin: 3px; position: relative; left: -4px;">{{ __('content.follow') }}  <b>+</b></button>
                            <br>
                    ...
                    @else
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span data-toggle="modal" data-target="#cancelsubscriptionmodal"
                                  class="btn btn-primary btn-outline play-sound6" style="width: 226px !important;">
        ...
        <b><i class="fa fa-check" style="font-size: 17px;" aria-hidden="true"></i></b>
                            ...
                            <!-- Spacer between the two buttons if needed -->
                                ...
                                <div>
                                    @auth
                                        ...
                                        @if($user->id !== auth()->id() && isset($subscription) && $subscription !== null)
                                            ...
                                            <button id="chat_with_me_btn" type="submit" class="btn btn-success"
                                                    style="border: 2px solid #409c40 !important; width:65px; height: 59px; display: inline-block; position: fixed; right:4px;top:65px; float: right; z-index: 1;">
                                                ✉️
                                            </button>
                                        @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-8 ">
                                                ...
                                                <form role="form" action="{{ route('stripe.post') }}" method="post"
                                                      ...
                                                      id="payment-form" style="text-align: left;color: white;">
                                                    ...
                                                    <div class='form-row row'>
                                                        ...
                                                        <div class='col-12 col-md-12 form-group cvc required'
                                                            ...
                                                            <label class='control-label'>CVC</label> <input
                                                                ...
                                                                placeholder='CVC / CVV / Security number' size='4'
                                                    ...
                                                    <div style="margin-bottom: 30px; ">
                                                        ...
                                                        <p style="margin: 0px;"><img
                                                                src="{{ asset('assets/images/cardesecurity.png') }}"
                                                                alt="" style="width: 50px;"> Your credit card payments
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <button class="btn btn-block mb-3" type="submit"
                                                                    ...
                                                                    style="max-width: 80px;margin-left: auto;margin-right: auto;color: #333;-webkit-color: #333;-moz-color: #333;background: #efefef;-webkit-background: #efefef;-moz-background: #efefef;">
                                                                Pay
                                                            </button>
                ...
                <div class="row animate-box" data-animate-effect="fadeInLeft">
                        ...
                        @foreach($all_posts as $post)
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
                                ...
                                <a href="{{ URL('/influencer/post_detail/'.$post_id.'')}}">
                                    ...
                                    @if ($followership === null)
                                        ...
                                        <img src="{{ asset('assets/images/blue24.png') }}"
                                             ...
                                             style="border-radius: 26px !important; border: 7px solid lightgray;width: 100%;max-height: 411px;">
                                ...
                                <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a class="post_stats"
                                        ...
                                        @if ($followership != null) class="like_post"
                                        @endif style="cursor: pointer;font-weight: 100;" post_id="{{$post->id}}"> <i
                                            class="@if($check_post_like == null) icon-heart-o @else icon-heart  @endif  post_icon_{{$post->id}} "
                                            post_id="{{$post->id}}" style=""></i></span> <span style="cursor: pointer;"
                                                                                               class="indiviual_post_likes"
                                                                                               post_id="{{$post->id}}"
                                                                                               @if ($followership != null) data-toggle="modal"
                                                                                               data-target="#PostLikesModalCenterindividual_another_influencer_user2" @endif>{{ __('content.likes') }} </span></a>
                                    &nbsp; </b></center>
                    ...
                    @else
                        ...
                        <p style="text-align: center;color: color: rgba(0, 0, 0, 0.5);;"><img
                                ...
                                style="margin-top: -7px;height: 32px;width: 25px;" alt=""> No hay posts todabía this is
                            a test &nbsp;&nbsp;
                        </p>
                    ...
                    {{-- <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
                      ...
                      <a href="pics/01.html">
                        ...
                        <img src="{{ asset('assets/images/blue24.png') }}" alt="Nueva Modelo Superfans - ¡Bienvenid@ a mi Portfolio!" class="img-responsive" style="border-radius: 26px !important; border: 7px solid lightgray;">
                    ...
                    {{-- @foreach($Influencer_network_ids as $Influencer_network_id)
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
                        ...
                        <a href="{{$Influencer_networks_profile_links[$index]}}">
                          ...
                          <img src="{{ asset('assets/images/'.$socialnetwork_feedimage.'') }}" alt="Nueva Modelo Superfans - ¡Bienvenid@ a mi Portfolio!" class="img-responsive" style="border-radius: 26px !important; border: 7px solid lightgray;width: 100%;max-height: 411px;">
                ...
                <div class="modal-content" style="border-radius: 20px;background: red;">
                    ...
                    <div class="modal-body" style="border: 0px">
                        ...
                        <form action="{{ url('/influencer/update_profile_image') }}" method="post"
                            ...
                            <div class="custom-file form-group row align-items-center" style="display: flex;">

                                <label for="" class="col-sm-3 col-form-label"> {{ __('content.profile_picture') }}</label>
                                <div class="col-sm-6">
                                    <input type="file" class="form-control-file" name="profile_image"
                                           id="validatedCustomFile" style="color: white;margin-top: 3px;" required>
                                </div>
                        ...
                        <form action="{{ url('/influencer/update_cover_image') }}" method="post"
                            ...
                            <div class="custom-file" style="display: flex;">
                                ...
                                <input type="file" class="custom-file-input" name="cover_image" id="validatedCustomFile"
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group" style="display: flex">
                                            ...
                                            <input type="text" class="form-control" id="price_of_subscription"
                                                   style="background: white;height: 40px;" name="price_of_subscription"
                                                   value="{{$user->price_of_subscription}}">
                            ...
                            <div class="container-fluid " style="padding-left: 0px;">
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col-xs-6" style="text-align: end;padding-right: 22px;">
                                        ...
                                        <button type="button"
                                                style="background: white;color: red;padding: 3px 15px;font-weight: bold;border: 0px;outline: 0px;"
                                                data-toggle="modal" data-target="#withdraw_earnings_modal">Withdraw
                                            money
                                        </button>
                        ...
                        <div class="container-fluid " style="padding-left: 0px;">
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="col-xs-6" style="text-align: end;padding-right: 22px;">
                                    ...
                                    <button type="button" class="launch_subscriber_list_modal launch_sub_modal"
                                            style="background: white;color: red;padding: 3px 15px;font-weight: bold;border: 0px;outline: 0px;"
                                ...
                                @foreach ($subscriptions as $subscription)
                                    ...
                                    <div
                                        ...
                                        <div style="text-align: right;margin-bottom: -25px;margin-right: -13px;">
                                            ...
                                            <a href="/user/delete_subscription/{{$subscription->id}}"
                                               onclick="return confirm('Confirm delete subscription? - Yes or No')"><i
                                                    class="far fa-trash-alt" style="cursor: pointer;color: black;"></i></a>
