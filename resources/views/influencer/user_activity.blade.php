...
<div class="modal" id="PostLikesModalCenterindividual_another_influencer_user2" tabindex="-1" role="dialog" aria-labelledby="subcriberlistModalCenterTitle" aria-hidden="true" style="z-index: 1898989898989898989898989;">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius: 20px;background: red;">
      <div class="modal-header" style="border: 0px">
        ...
        <h5 class="modal-title" id="exampleModalCenterTitle" style="font-size: 30px;text-align: center;color: white;display: inline-block;">{{ __('content.likes') }} </h5>
      </div>
      </div>
              ...
              <div class="post_div post_div_{{$post->id}}">
                ...
                @endphp
                  ...
                  @php
                        ...
                        $user_of_like = DB::table('users')->where('id',$user_id)->first();
                        $profile_picture = $user_of_like->profile_picture;
                  @endphp
      
                  <div style="background: white;padding: 10px 5px;display: inline-block;margin: 10px;">
                    
                    <p style="margin: 0px">              @if ($profile_picture != null)
                      <img src="{{ asset('assets/images/'.$profile_picture.'') }}" style="width: 34px; height: 34px; border-radius: 74px;">    
                      @else
                      <img src="{{ asset('assets/images/output-onlinepngtools (2).png') }}" style="width: 34px; height: 34px; border-radius: 74px;">
                      @endif              <span>@</span>{{$user_of_like->username_URL}}</p>
...
<div id="fh5co-page">
    ...
    border-radius: 30px;vertical-align: middle;"></span><span>@</span>{{$user->username_URL}}</p>
      ...
      @endphp
          ...
          <li> <a class="fh5co-active" href="{{ URL('/influencer/user/'.$username_URL.'')}}" style="text-decoration: underline;text-transform: uppercase;
          ...
          <li> <a href="{{ URL('/influencer/user_posts/'.$username_URL.'')}}" style="text-transform: uppercase;
        ...
        <nav id="fh5co-main-menu" role="navigation">
            ...
            <ul>
                ...
                <li>
                  ...
                  $user = DB::table('users')->where('id',$another_user_id)->first();
    ...
    <div id="fh5co-main">
        ...
        <div class="fh5co-narrow-content" style="padding-top: 0px;margin-top: -54px;">
          ...
          @endif --}}
              ...
              @endif              
                ...
                <form action="{{ url('/user/follow') }}" method="post" enctype="multipart/form-data">
                  ...
                  @csrf                  
                    ...
                    <button @if(Auth::user()->id == $user->id) data-toggle="modal" data-target="#exampleModalCenter" type="button" @endif class="btn btn-primary btn-outline" style="width: 226px !important;"><img src="{{ asset('assets/images/SUPERHEROINA.svg') }}" style="width: 17.47%; margin: 3px; position: relative; left: -4px;">{{ __('content.follow') }}  <b>+</b></button><br>
            ...
            <b><a href="{{ URL('/influencer/user_posts/'.$username_URL.'')}}" style="font-size: 0.69em;">{{$posts_count}}</b> {{ __('content.post') }}</a> | <b><a href="#" @if ($followership != null)  data-toggle="modal" data-target="#LikesactivityModalCenter" @endif style="font-size: 0.69em;"><span class="number_of_likes">{{thousandsCurrencyFormat($likes_count)}}</span></b> {{ __('content.likes') }} </a> | <b><a href="#" @if ($followership != null)  data-toggle="modal" data-target="#followerlistmodalanotheruser" class="direct_subscriber_list" @endif style="font-size: 0.69em;">{{thousandsCurrencyFormat($subscription_count)}}</b> {{ __('content.followers') }}</a>



                                          <!-- Modal Likes list -->

                                          <div class="modal" id="LikesactivityModalCenter" tabindex="-1" role="dialog" aria-labelledby="subcriberlistModalCenterTitle" aria-hidden="true" style="z-index: 1288912889;">
                                                      ...
                                                      <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                          ...
                                                          @if (!in_array($influencer_id ,$influencer_user_ids))
                                                            <div class="col-xs-3 " style="padding-left: 5px;padding-right: 5px;max-width: 225px;display: inline-block;">
                                                              <div  style="background: white;padding: 10px 5px;margin-top: 10px;overflow-x: auto;max-width: 100%;">
                                                                
                                                                @php
                                                                $profile_picture = $user->profile_picture;
                                                            @endphp
                                                            <p style="margin: 0px;display: flex;"> <img @if ($profile_picture != null)
                                                              src="{{ asset('assets/images/'.$profile_picture.'') }}"
                                                            @else
                                                            src="{{ asset('assets/images/output-onlinepngtools (2).png') }}"
                                                            @endif style="max-width: 28px" alt=""> {{$user->username_URL}}</p>
...
<div class="modal" id="followerlistmodalanotheruser" tabindex="-1" role="dialog" aria-labelledby="subcriberlistModalCenterTitle"  aria-hidden="true" style="z-index: 1288912889;">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content" style="border-radius: 20px;background: red;">
      ...
      <div class="modal-header" style="border: 0px">
        ...
        <h5 class="modal-title" id="exampleModalCenterTitle" style="font-size: 30px;text-align: center;color: white;display: inline-block;">{{ __('content.followers') }}</h5>
        ...
        @php
          ...
          @endphp
            ...
            @php
                  ...
                  $user_subscribed = DB::table('users')->where('id',$user_id)->first();
            ...
            <div style="background: white;padding: 10px 5px;display: inline-block;margin: 10px;">
              ...
              $profile_picture = $user_subscribed->profile_picture;

          @endphp

          <p style="margin: 0px"> <img @if ($profile_picture != null)
          ...
          @endif style="max-width: 28px" alt=""> {{$user_subscribed->username_URL}}</p>
          ...
          @endforeach                    
            ...
            @else
                ...
                <p style="margin: 0px;text-align: center;color: white;">This user have no subscribers or followers yet</p>
...
$likes = DB::select("SELECT * FROM posts WHERE id = ". $post->id);
                                ...
                                $likes_value=$likes_no;
                              @endphp

                              {{-- <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a class="post_stats" style="font-size: 0.69em;"><span class="number_of_post_likes post_likes_{{$post->id}}"> {{ wordwrap($post_likes_count, 4, ".", true);}}</span></b><span @if ($check_post_like != null) class="like_post" @endif style="cursor: pointer;font-weight: 100;" post_id="{{$post->id}}"> <i class="@if($check_post_like == null) icon-heart-o @else icon-heart  @endif  post_icon_{{$post->id}} " post_id="{{$post->id}}" style="font-size: 0.92em !important;"></i> </span><span   style="font-size: 0.92em !important;cursor: pointer;" class="indiviual_post_likes" post_id="{{$post->id}}" @if ($followership != null) data-toggle="modal" data-target="#PostLikesModalCenterindividual_another_influencer_user" @endif>{{ __('content.likes') }} </span></a> &nbsp; </b></center> --}}

                              <center >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a class="post_stats" style="font-size: 0.69em;" ><span class="number_of_post_likes post_likes_{{$post->id}}">
                                  @php
                                     if($likes_value <= 1000){
                                        echo $post_likes_count+$likes_value;
                                        }elseif($likes_value > 1000000 ){
                                            echo $post_likes_count+number_format($likes_value/1000000,1) . "M";
                                        }elseif($likes_value > 1000){
                                            echo number_format($post_likes_count+$likes_value/1000,1) . "K";
                                        }

                                @endphp
                              </span></b><span @if ($followership != null) class="like_post" @endif style="cursor: pointer;font-weight: 100;" post_id="{{$post->id}}" > <i   class="@if($check_post_like == null) icon-heart-o @else icon-heart  @endif  post_icon_{{$post->id}} " post_id="{{$post->id}}"    style=""></i></span> <span   style="cursor: pointer;" class="indiviual_post_likes" post_id="{{$post->id}}" @if ($followership != null) data-toggle="modal" data-target="#PostLikesModalCenterindividual_another_influencer_user2" @endif>{{ __('content.likes') }} </span></a> &nbsp; </b></center>
                          ...
                          <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item" style="display: flex;align-items: center;">
                            ...
                            <center style="width: 100%;margin-bottom: 0.29em;">
                              ...
                              @if (count($last_three_posts) > 0)
                                ...
                                <a href="{{ URL('/influencer/user_posts/'.$username_URL.'')}}" class="btn btn-primary btn-outline">{{ __('content.all_posts') }}</a>
