    ...
    <script>
     ...
     let clickCount = 0;
        ...
        <div class="fh5co-footer" style="position: inherit !important;">
            ...
            <p><small>&copy; 2021-2025  @if(Auth::user()->footer_name_username == "username") <span style="display: inline-block;">@</span>{{Auth::user()->username_URL}} @else {{Auth::user()->name}} {{Auth::user()->surname}} @endif  <br>{{ __('footer.all_rights_reserved') }}</span> <span>{{ __('footer.powered_by') }} <a href="https://live.superfanss.app/world">SUPERFANSS.APP</a> </span> </small></p>
        </div>
                ...
                <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                    <figure class="text-center">
                        ...
                        @php
                          ...
                          @endforeach
                              {{-- <img src="{{ asset('assets/images/'.$image_video.'') }}" data-toggle="modal" data-target="#postimageModalCenter"  alt="Nueva Modelo Superfans - Â¡Bienvenid@ a mi Portfolio!" class="img-responsive" style="border-radius: 26px !important; border: 7px solid lightgray;max-width: 100%;max-height: 411px;">     --}}
